 ...
 */
EC2.prototype.create = function(params, instanceParams) {
 ...
 * @param {object} params
 */
EC2.prototype.list = function(params) {
  const ec2 = new this._AWS.EC2({ apiVersion: this._apiVersion });
 ...
 * @param {object} params
 */
EC2.prototype.start = function(params) {
  const ec2 = new this._AWS.EC2({ apiVersion: this._apiVersion });
 ...
 * @param {object} params
 */
EC2.prototype.stop = function(params) {
  const ec2 = new this._AWS.EC2({ apiVersion: this._apiVersion });
 ...
 * @param {object} params
 */
EC2.prototype.reboot = function(params) {
  const ec2 = this._ec2;
 ...
 * @param {object} params
 */
EC2.prototype.destroy = function(params) {
  const ec2 = this._ec2;
  return new Promise((resolve, reject) => {
